...
BOT = "https://files.catbox.moe/r8lice.jpg"
IMG = [
    ...
    "https://files.catbox.moe/asw6ta.jpg",
    "https://files.catbox.moe/knziw8.jpg",
...
async def start(_, m: Message):
    ...
    if m.chat.type == ChatType.PRIVATE:
        ...
        await accha.edit("**__Power__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powere__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered B__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By L__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Le__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Leg__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Legit__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Legit s__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Legit sт__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Legit ѕтα__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Legit ѕтαя__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Legit sтαят__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Legit sтαятι__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Legit sтαятιи__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Legit sтαятιиg__**")
        await asyncio.sleep(0.01)
        await accha.edit("**__Powered By Legit ѕтαятιиg.__**")
        await asyncio.sleep(0.1)
        await accha.edit("**__Powered By Legit sтαятιиg.....__**")
        await asyncio.sleep(0.1)
        await accha.edit("**__Powered By Legit ѕтαятιиg.__**")
        await asyncio.sleep(0.1)
        await accha.edit("**__Powered By Legit sтαятιиg.....__**")
