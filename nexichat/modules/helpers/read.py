...
╔═════════════════╗
║ ➻ ᴍʏ ʀᴇᴘᴏ ➪ [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://github.com/amritraj78/KING-CHAT)  
║ ➻ ᴄʀᴇᴀᴛᴏʀ ➪ [ʙʀᴀɴᴅᴇᴅ ✯ ᴋɪɴɢ](https://t.me/it_amrit)                         
╚═════════════════╝
**"""
...
──────────────
๏ ᴍᴀᴅᴇ ʙʏ ➪ [ʙʀᴀɴᴅᴇᴅ ✯ ᴋɪɴɢ](https://t.me/it_amrit) 💞**
"""
...
➻ /stats - ɢᴇᴛ ʙᴏᴛ ꜱᴛᴀᴛꜱ
──────────────
📡 ᴍᴀᴅᴇ ʙʏ ➪ [ʙʀᴀɴᴅᴇᴅ ✯ ᴋɪɴɢ](https://t.me/LOYAL_KINGDOM) 💞**
"""

SOURCE_READ = f"**ʜᴇʏ, ᴛʜᴇ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ᴏғ [{nexichat.name}](https://t.me/{nexichat.username}) ɪs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.**\n**ᴘʟᴇᴀsᴇ ғᴏʀᴋ ᴛʜᴇ ʀᴇᴘᴏ & ɢɪᴠᴇ ᴛʜᴇ sᴛᴀʀ ✯**\n**──────────────────**\n**ʜᴇʀᴇ ɪs ᴛʜᴇ [sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ](https://github.com/amritraj78/KING-CHAT)**\n**──────────────────**\n**ɪғ ʏᴏᴜ ғᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ᴛʜᴇɴ ᴄᴏɴᴛᴀᴄᴛ ᴀᴛ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ](https://t.me/{SUPPORT_GRP}).\n<b>||📡 ᴍᴀᴅᴇ ʙʏ ➪ [ʙʀᴀɴᴅᴇᴅ ✯ ᴋɪɴɢ](https://t.me/LOYAL_KINGDOM) 💞**||</b>"
